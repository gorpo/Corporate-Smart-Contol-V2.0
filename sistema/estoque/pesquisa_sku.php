  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Controle de Estoque - Pesquisar produto pelo SKU</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="blocoPesquisa">
        ...
        <tbody>
          <p>Para pesquisar o produto digite o codigo SKU na barra abaixo.</p>
...
$info = null;
  if(isset($_GET['buscar'])){
    ...
    $sql = $pdo->prepare("SELECT * FROM produtos WHERE  referencia LIKE '%$buscar%' ");
  }
      $sql->execute();
      $info = $sql->fetchAll();
  }
  if (is_array($info) || is_object($info))
{
    ...
    foreach ($info as $key => $row) {
      ...
      echo '<form  action="reduz_estoque_pesquisa_sku.php"  >';
...
//CASO NAO SEJA REALIZADA NENHUMA BUSCA A PAGINA APRESENTA AS INFORMAÇÕES DO ADMINISTRADOR
    ...
    echo '<div class="alert alert-danger alert-dismissible">
          <p>Para pesquisar o produto digite o SKU na barra abaixo, você será direcionado ao produto.<br>

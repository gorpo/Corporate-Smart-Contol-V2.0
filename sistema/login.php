...
foreach($info as $key => $row){
	if($row['email'] != $email){
		...
		if($row['email'] == $email)
			    ...
			    $pdo = Database::conectar($dbNome='csc_'.$email);
			    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			    $sql = $pdo->prepare("ALTER TABLE `customizar` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
			    $sql->execute();
			    $pdo = Database::desconectar();
			    ...
			    $pdo = Database::conectar($dbNome='csc_'.$email);
			    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			    $sql = $pdo->prepare("ALTER TABLE `informacoes` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
			    $sql->execute();
			    $pdo = Database::desconectar();
			    ...
			    $pdo = Database::conectar($dbNome='csc_'.$email);
			    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			    $sql = $pdo->prepare("ALTER TABLE `login_representantes` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
			    $sql->execute();
			    $pdo = Database::desconectar();
			    ...
			    $pdo = Database::conectar($dbNome='csc_'.$email);
			    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			    $sql = $pdo->prepare("ALTER TABLE `representantes` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
			    $sql->execute();
			    $pdo = Database::desconectar();
			    ...
			    $pdo = Database::conectar($dbNome='csc_'.$email);
			    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			    $sql = $pdo->prepare("ALTER TABLE `ordem_servico` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
			    $sql->execute();
			    $pdo = Database::desconectar();
			    ...
			    $pdo = Database::conectar($dbNome='csc_'.$email);
			    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			    $sql = $pdo->prepare("ALTER TABLE `produtos` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
			    $sql->execute();
			    $pdo = Database::desconectar();
			    ...
			    foreach($info as $key => $row){
			        ...
			        if($email_cadastrado == $email){
						...
						if($rows == 0){
						    ...
						    $pdo = Database::conectar($dbNome='csc_'.$email);
						    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						    $sql = $pdo->prepare("ALTER TABLE `user_$usuario_cadastrado` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
						    $sql->execute();
						    $pdo = Database::desconectar();
						    ...
						    $pdo = Database::conectar($dbNome='csc_'.$email);
						    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						    $sql = $pdo->prepare("ALTER TABLE `retiradas_$usuario_cadastrado` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;");
						    $sql->execute();
						    $pdo = Database::desconectar();

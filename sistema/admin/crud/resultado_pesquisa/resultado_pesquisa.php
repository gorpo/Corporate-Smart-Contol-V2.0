        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"> <a href="../desenvolvedor/consulta_ordem_servico.php" class="nav-link "><i class="nav-icon fas fa-laptop-code"></i><p>null</p></a></li>
            </ul>
          </li>
  ...
  if (is_array($info) || is_object($info))
{
    ...
    foreach ($info as $key => $row) {
      ...
      echo '<form  action="aumenta_estoque_resultado_pesquisa.php"  >';
...
function exclusao($id) {
    ...
    if (msg){
        ...
        window.location.href=("resultado_pesquisa.php?id="+$id);
    }
    else{

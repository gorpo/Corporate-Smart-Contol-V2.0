        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item "><a href="#" class="nav-link "><i class="nav-icon fas fa-tachometer-alt"></i><p> Dashboard<i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="../dashboard/index.php" class="nav-link "><i class="fas fa-users nav-icon"></i><p>Usuários</p></a></li>
      ...
      <li class="nav-item ">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item"><a href="../cadastro_usuarios/cadastro_usuarios.php" class="nav-link"><i class="far fa-user nav-icon"></i><p>Verificar acessos</p></a></li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item"> <a href="produtos_cadastrados.php" class="nav-link"><i class="fas fa-cube nav-icon"></i><p>Produtos Cadastrados</p></a></li>
              <li class="nav-item"> <a href="index.php" class="nav-link"><i class="fas fa-cube nav-icon"></i><p>Produto Único</p></a></li>
              <li class="nav-item"> <a href="produto_composto.php" class="nav-link"> <i class="fas fa-cube nav-icon"></i> <p>Produto Composto</p></a></li>
              <li class="nav-item"> <a href="produto_composto_idade.php" class="nav-link"> <i class="fas fa-cube nav-icon"></i> <p>Produto Idade</p></a> </li>
              <li class="nav-item">  <a href="produto_composto_sapatilha.php" class="nav-link"> <i class="fas fa-cube nav-icon"></i> <p>Produto Sapatilhas</p></a> </li>
            </ul>
          </li>

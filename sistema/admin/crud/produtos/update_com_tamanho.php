...
<! -- ================================================  CADASTRO DE PRODUTOS ================================================   -->
    ...
    <form class="form-horizontal" action="update.php?id=<?php echo $id ?>"  method="post"  autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="site-center-col-inner">
          ...
          <div class="  m-b-16" >
            ...
            <label >Código Barra EAN13</label>
             <div class="controls">
                <input class="input100" type="text" name="codigo_barra" type="text" placeholder="<?php if (!empty($codigo_barraErro)): echo $codigo_barraErro; endif;?>" value="<?php echo  $codigo_barra ; ?>">

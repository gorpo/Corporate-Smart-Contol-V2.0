  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Atualizar Produto Tamanho Único </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
...
<! -- ================================================  CADASTRO DE PRODUTOS ================================================   -->
    ...
    <form class="form-horizontal" action="update_produtos_cadastrados.php?id=<?php echo $id ?>"  method="post"  autocomplete="off" enctype="multipart/form-data">
            ...
            <label >Tamanho</label>
             <div class="controls">
                <select class="input100" name="tamanho" id="tamanho">
                    ...
                    <option class="input100" value="UNICO">UNICO</option>
                    ...
                    <option class="input100" value="2 Anos">2 Anos</option>
                    <option class="input100" value="4 Anos">4 Anos</option>
                    <option class="input100" value="6 Anos">6 Anos</option>
                    <option class="input100" value="8 Anos">8 Anos</option>
                    <option class="input100" value="17_18">17_18</option>
                    <option class="input100" value="19_20">19_20</option>
                    <option class="input100" value="21_22">21_22</option>
                    <option class="input100" value="23_24">23_24</option>
                    <option class="input100" value="25_26">25_26</option>
                    <option class="input100" value="27_28">27_28</option>
                    <option class="input100" value="29_30">29_30</option>
                    <option class="input100" value="31_32">31_32</option>
                    <option class="input100" value="33_34">33_34</option>
                    <option class="input100" value="35_36">35_36</option>
                </select>

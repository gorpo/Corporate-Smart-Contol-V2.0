  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Cadastro de Produto Tamanho Único</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <div class="control-group " style="margin-top: 35px;">
                        <div class="controls">
                          <?php 
                            ...
                            echo "<img class='tamanho_imagemUnico' src='../../../../assets/images/caixa.png' >";
                            echo "</div>";
                            }else{
                              echo "<div class='inputUploadImagemUnico'>";
    ...
    <div class="site-left-col-inner">
          ...
          <div class="  m-b-16" >
            ...
            <label >Quantidade</label>
             <div class="controls">
            <input class="input100" type="text" name="quantidade" type="text" placeholder="<?php if (!empty($quantidadeErro)): echo $quantidadeErro; endif;?>"value="">
    ...
    <div class="site-center-col-inner">
          ...
          <div class="  m-b-16" >
            ...
            <label >Código Barra EAN13</label>
             <div class="controls">
                <input class="input100" type="text" name="codigo_barra" type="text" placeholder="<?php if (!empty($codigo_barraErro)): echo $codigo_barraErro; endif;?>"value="">
  ...
  if (is_array($info) || is_object($info))
{
    ...
    foreach ($info as $key => $row) {
      ...
      echo '<form  action="aumenta_estoque_unico.php"  >';
  ...
  $info = $sql->fetchAll();
  foreach($info as $key => $row)
  { //$tipo_produtoa = $row['tipo_produto'];
    //$tipo_produto = ucwords(str_replace("_"," ","$tipo_produtoa"));
      echo '<table> <tr> <td class="preto">';
      echo '<img  class="caixa_imagem"  src="../../../../assets/images/produtos/'.$row['imagem'].'"/> </td></a>';
      echo '<td class="preto"> <p class="textoTabela">'.mb_strimwidth($row['produto'], 0 , 22, '...').'</p> ';
      echo '<p class="textoTabela">Referência SKU: '.$row['referencia'].'</p> ';

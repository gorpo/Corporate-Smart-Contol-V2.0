...
//mata a sessao representante e carrinho e pega o representante via get
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" id="navbar_cor"> 
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="" class="nav-link">Fechamento do Carrinho</a>
      </li>
    </ul>
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <?php
                  echo '<a href="print.php?representante='.$representante.'" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>';
                  echo '         ';
                  //echo '<a href="envia_email.php?representante='.$representante.'" rel="noopener"  class="btn btn-default"><i class="fas fa-envelope"></i> Email</a>';

      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item"> <a href="index.php" class="nav-link "><i class="nav-icon fas fa-file-invoice"></i><p>Gerar O.S.</p></a></li>
              <li class="nav-item"> <a href="consulta_ordem_servico.php" class="nav-link "><i class="nav-icon fas fa-file-invoice"></i><p>Consultar O.S</p></a></li>
            </ul>
          </li>

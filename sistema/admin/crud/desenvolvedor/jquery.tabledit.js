 ...
 */
//da um load no css para aparecer os botoes $('head').append('<link rel="stylesheet" type="text/css" href="style.css">');
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        if ($table.find('th.tabledit-toolbar-column').length === 0) {
                            $table.find('tr:first').append('<th class="tabledit-toolbar-column" style="color: black;">Controles</th>');
                        }

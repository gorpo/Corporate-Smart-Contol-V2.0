...
<!-- ================================================ CAIXAS DAS INFORMAÇÕES DO TOPO ================================================ -->
    ...
    </div><!-- FINAL DAS CAIXAS DAS INFORMAÇÕES DO TOPO -->
...
<script type="text/javascript">/* POP UP INFORMANDO PRODUTOS ACIMA DO ESTOQUE */
function produtos_acima_estoque() {
    var js_array = confirm([<?php echo '"'.implode('\n', $produtos_acima_estoque).'"' ?>]);
    }
</script>

<script type="text/javascript">/* POP UP INFORMANDO PRODUTOS EM FALTA */
function produtos_em_falta() {
    var js_array = confirm([<?php echo '"'.implode('\n', $produtos_em_falta).'"' ?>]);
    }
</script> -->

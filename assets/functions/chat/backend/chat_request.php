...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'send_chat')
	{
	    ...
	    else
	    {
	        ...
	        {
	        	//descomentar linha abaixo e comentar a $formdata para nao permitir enter
	    ...
	    if($error == '')
	    {
	    	...
	    	<div class="card text-white bg-info mb-3 w-75 float-end">
	    		...
	    		<div class="card-footer text-white text-end"><small><img src="../../../../assets/images/usuarios/'.$sender_data['ui'].'" width="25" class="rounded-circle me-2" /><b>'.$sender_data['un'].'</b> on '.date('l j F Y h:i:s A', time()).'</small></div>
	    	</div>
	    	';
	    }
